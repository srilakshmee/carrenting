...
--
-- Host: localhost    Database: vehicle_renting
-- ------------------------------------------------------
...
CREATE TABLE `bookings` (
  ...
  `letter_sent` tinyint(4) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `vehicles` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `type` FOREIGN KEY (`id`) REFERENCES `vehicle_types` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-04-12 22:02:18
